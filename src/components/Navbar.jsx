const Navbar = () => {
  return (
    <>
      {/* ========== HEADER ========== */}
      <header className="relative z-50 bg-transparent flex flex-wrap md:justify-start md:flex-nowrap w-full py-7">
        <nav
        ...
        >
          ...
          >
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:justify-center md:items-center md:gap-y-0 md:gap-x-7 md:mt-0">
              <div>
                <a
                  className="relative inline-block text-white before:absolute before:bottom-0.5 before:start-0 before:-z-[1] before:w-full  dark:text-white"
                  href="#"
                  aria-current="page"
                >
                  Work
